...
raw_data <- data.frame(
  ...
  Alpha_Precision = c(0.915, 0.867, 0.663, 0.974, 0.963, 0.972),
  Beta_Recall = c(0.427, 0.444, 0.239, 0.496, 0.515, 0.489),
  ...
  Accuracy = c(0.888, 0.814, 0.637, 0.878, 0.870, 0.838)
)
...
pdf(file = "Heart Failure Prediction Data/evaluation_utility/all_radar_plots_normalized.pdf", width = 9, height = 6)
...
disclosure_risk_data <- data.frame(
  row.names = c("ARF", "CTGAN", "PrivBayes", "Synthpop", "TABSYN", "TVAE"),
  IMS = c(0.000, 0.000, 0.004, 0.002, 0.000, 0.000),
  DCR = c(0.044, 0.040, 0.080, 0.042, 0.035, 0.044),
  NNDR = c(0.747, 0.773, 0.820, 0.725, 0.722, 0.766),
  M = c(0.072, 0.027, 0.067, 0.014, -0.001, 0.025),
  TCAP = c(0.623, 0.476, 0.509, 0.596, 1.000, 0.464),
  Authenticity = c(0.524, 0.547, 0.647, 0.489, 0.497, 0.491)
)
...
# Open PDF
pdf(file = "Heart Failure Prediction Data/evaluation_disclosure_risk/disclosure_risk_radar.pdf", width = 9, height = 6)
